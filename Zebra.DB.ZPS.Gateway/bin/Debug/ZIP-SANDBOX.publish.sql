/*
Deployment script for ZIP_SANDBOX
...
:setvar DatabaseName "ZIP_SANDBOX"
:setvar DefaultFilePrefix "ZIP_SANDBOX"
...
GO
PRINT N'Dropping [acct].[DF_Invoice_VaultTag]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_VaultTag];


GO
PRINT N'Dropping [acct].[DF_Invoice_ContractID]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_ContractID];


GO
PRINT N'Dropping [acct].[DF_Invoice_DueDate]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_DueDate];


GO
PRINT N'Dropping [acct].[DF_Invoice_DueBalance]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_DueBalance];


GO
PRINT N'Dropping [acct].[DF_Invoice_IssueDate]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_IssueDate];


GO
PRINT N'Dropping [acct].[DF_Invoice_InvoicedOn]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [DF_Invoice_InvoicedOn];


GO
PRINT N'Dropping unnamed constraint on [tms].[_SvcFactor]...';


GO
ALTER TABLE [tms].[_SvcFactor] DROP CONSTRAINT [DF___SvcFacto__FuelS__0A5513C6];
...
GO
ALTER TABLE [tms].[_SvcFactor] DROP CONSTRAINT [DF___SvcFacto__Handl__0960EF8D];
...
GO
ALTER TABLE [tms].[_SvcFactor] DROP CONSTRAINT [DF___SvcFacto__Handl__086CCB54];


GO
PRINT N'Dropping [tms].[DF_SvcType_CmdyRootID]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [DF_SvcType_CmdyRootID];


GO
PRINT N'Dropping [tms].[DF_SvcType_DutyCurrencyID]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [DF_SvcType_DutyCurrencyID];


GO
PRINT N'Dropping [tms].[DF_SvcType_UseFactor]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [DF_SvcType_UseFactor];
...
GO
PRINT N'Dropping [acct].[FK_Ledger_Invoice]...';


GO
ALTER TABLE [acct].[_Ledger] DROP CONSTRAINT [FK_Ledger_Invoice];


GO
PRINT N'Dropping [acct].[FK_VaultXact_Invoice]...';


GO
ALTER TABLE [acct].[_VaultXact] DROP CONSTRAINT [FK_VaultXact_Invoice];


GO
PRINT N'Dropping [acct].[FK_Invoice_Currency]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [FK_Invoice_Currency];


GO
PRINT N'Dropping [acct].[FK_Invoice_Party]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [FK_Invoice_Party];


GO
PRINT N'Dropping [acct].[FK_Invoice_Contract]...';


GO
ALTER TABLE [acct].[_Invoice] DROP CONSTRAINT [FK_Invoice_Contract];


GO
PRINT N'Dropping [tms].[FK_SvcFactor_RcvHub]...';


GO
ALTER TABLE [tms].[_SvcFactor] DROP CONSTRAINT [FK_SvcFactor_RcvHub];


GO
PRINT N'Dropping [tms].[FK_SvcContract_SvcType]...';


GO
ALTER TABLE [tms].[_SvcContract] DROP CONSTRAINT [FK_SvcContract_SvcType];


GO
PRINT N'Dropping [shpt].[FK_Parcel_SvcType]...';


GO
ALTER TABLE [shpt].[_Parcel] DROP CONSTRAINT [FK_Parcel_SvcType];


GO
PRINT N'Dropping [tms].[FK_SvcType_Tenant]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [FK_SvcType_Tenant];


GO
PRINT N'Dropping [tms].[FK_SvcType_Currency]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [FK_SvcType_Currency];


GO
PRINT N'Dropping [tms].[FK_SvcType_ClrMethod]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [FK_SvcType_ClrMethod];


GO
PRINT N'Dropping [tms].[FK_SvcType_InitState]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [FK_SvcType_InitState];


GO
PRINT N'Dropping [tms].[FK_SvcType_Commodity]...';


GO
ALTER TABLE [tms].[_SvcType] DROP CONSTRAINT [FK_SvcType_Commodity];


GO
PRINT N'Dropping [tms].[FK_SvcRoute_SvcType]...';


GO
ALTER TABLE [tms].[_SvcRoute] DROP CONSTRAINT [FK_SvcRoute_SvcType];


GO
PRINT N'Dropping [tms].[FK_SvcRate_SvcType]...';


GO
ALTER TABLE [tms].[_SvcRate] DROP CONSTRAINT [FK_SvcRate_SvcType];
...
RETURN 
    (SELECT isnull(CAST (d.SkuID AS BIGINT), 0) AS ID,
     ...
     FROM   tvp.Many#Slice(@skuNbrs) AS x CROSS APPLY loc.SkuNbr#Cast(x.Piece) AS c
            ...
            invt.Sku#Raw() AS t
            ON t.TenantID = p.PID
               AND t.SkuNbr = c.SkuNbr OUTER APPLY (SELECT TOP (1) SkuID
                                                    FROM   invt.SkuBrokerage#Raw()
                                                    WHERE  SkuID = t.ID
                                                           AND ClrMethodID = (SELECT ClrMethodID
                                                                              FROM   tms.SvcType#For(@svcType, @siteID))) AS d)
...
RETURN 
    (SELECT u.ID,
            ...
            ChargeID,
            Supplement
     FROM   core.Party#Raw() AS x CROSS APPLY (SELECT x.ID,
                                                      v.VaultBal,
                                                      x.CurrencyID,
                                                      x.TalliedOn,
                                                      ChargeID,
                                               ...
                                               FROM   acct.Ledger#Raw() AS x
                                                      ...
                                                      ON x.PartyID = v.PartyID
                                                         AND x.CurrencyID = v.CurrencyID CROSS APPLY core.RefNbr#Type() AS k
                                                      INNER JOIN
                                                      core.RefNbr#Raw() AS r
                                                      ON r.MatterID = k.AsnNbr
                                               UNION ALL
                                               SELECT x.ID,
                                                      v.VaultBal,
                                                      x.CurrencyID,
                                               ...
                                               FROM   acct.Ledger#Raw() AS x CROSS APPLY core.Matter#Type() AS k
                                                      ...
                                                      ON m.ID = x.MatterID
                                                         AND m.Type IN (k.AssortedFees, k.StorageFee)
                                                      INNER JOIN
                                                      acct.Vault#Raw() AS v
                                                      ON x.PartyID = v.PartyID
                                                         AND x.CurrencyID = v.CurrencyID CROSS APPLY core.Registry#ID() AS r
                                                      INNER JOIN
                                               ...
                                               FROM   acct.Ledger#Raw() AS x
                                                      ...
                                                      acct.Vault#Raw() AS v
                                                      ON x.PartyID = v.PartyID
                                                         AND x.CurrencyID = v.CurrencyID CROSS APPLY core.RefNbr#Type() AS t
                                                      INNER JOIN
                                                      core.RefNbr#Raw() AS r
                                                      ON r.MatterID = m.ID
                                                      ...
                                                      ON p.MatterID = m.ID
                                                         AND p.Type = t.PostCourier CROSS APPLY tms.SvcRate#For(m.SvcType, m.RcvHubID, m.Weight) AS s
                                               UNION ALL
                                               SELECT x.ID,
                                                      v.VaultBal,
                                                      x.CurrencyID,
                                               ...
                                               FROM   acct.Payment#Raw() AS x
                                                      ...
                                                      acct.Vault#Raw() AS v
                                                      ON x.PartyID = v.PartyID
                                                         AND x.CurrencyID = v.CurrencyID) AS u
     WHERE  x.ID = 10681)
...
RETURN 
    (SELECT x.ID,
            ...
            p.PID AS TenantID,
            e.Tvp AS Activities
     FROM   shpt.Parcel#Deep() AS x CROSS APPLY core.Party#Type() AS k
            INNER JOIN
            core.Party#Raw() AS p
            ON p.ID = x.SiteID
               AND p.Type = k.TenantSite OUTER APPLY (SELECT concat(k.Many, Stage, k.Quad, TalliedOn, k.Quad, t.UtcOffset, k.Quad, p.UtcOffset) AS [text()]
...
RETURN 
    (SELECT ID,
            ...
            t.CourierNbr,
            t.Tracks
     FROM   shpt.Parcel#Deep() AS x CROSS APPLY svc.Parcel$Track(x.ID) AS t OUTER APPLY (SELECT TalliedOn AS OutgatedOn
                                                                                         FROM   core.Activity#Raw() AS a
                                                                                                INNER JOIN
                                                                                                core.State#Raw() AS t
                                                                                                ON a.StateID = t.ID CROSS APPLY core.Stage#ID() AS k
                                                                                         WHERE  Stage = k.Outgated
                                                                                                AND MatterID = x.ID) AS c)
     ...
     WHERE  x.Source = k.eVMI
            ...
            AND (NULLIF (@trackingNbr, '') IS NULL
                 OR EXISTS (SELECT MatterID
                            FROM   core.RefNbr#ScanOne(@trackingNbr, DEFAULT, DEFAULT)
                            WHERE  MatterID = x.ID)))
...
GO
PRINT N'Dropping [core].[Measure#Todo]...';


GO
DROP FUNCTION [core].[Measure#Todo];
...
GO
PRINT N'Dropping [xpd].[Sack$Verify]...';


GO
DROP FUNCTION [xpd].[Sack$Verify];
...
GO
PRINT N'Dropping [xpd].[Parcel$OverLabelForXpd]...';


GO
DROP PROCEDURE [xpd].[Parcel$OverLabelForXpd];
...
GO
PRINT N'Removing schema binding from [tms].[SvcType#Raw]...';
...
GO
PRINT N'Starting rebuilding table [acct].[_Invoice]...';
...
CREATE TABLE [acct].[tmp_ms_xx__Invoice] (
    [ID]         [dbo].[I64] IDENTITY (10000, 1) NOT NULL,
    [PartyID]    [dbo].[I32] NOT NULL,
    [ContractID] [dbo].[I32] CONSTRAINT [DF_Invoice_ContractID] DEFAULT (0) NOT NULL,
    [VaultTag]   [dbo].[E8]  CONSTRAINT [DF_Invoice_VaultTag] DEFAULT (0) NOT NULL,
    [LedgerSide] [dbo].[E8]  NOT NULL,
    [InvoiceNbr] CHAR (40)   CONSTRAINT [DF_Invoice_InvoiceNbr] DEFAULT ('') NOT NULL,
    [CurrencyID] [dbo].[E8]  NOT NULL,
    [DueBalance] [dbo].[amt] CONSTRAINT [DF_Invoice_DueBalance] DEFAULT (0) NOT NULL,
    [InvoiceAmt] [dbo].[amt] NOT NULL,
    [InvoicedOn] [dbo].[DT]  CONSTRAINT [DF_Invoice_InvoicedOn] DEFAULT (getutcdate()) NOT NULL,
    [IssueDate]  [dbo].[DT]  CONSTRAINT [DF_Invoice_IssueDate] DEFAULT (getutcdate()) NOT NULL,
    [DueDate]    [dbo].[DT]  CONSTRAINT [DF_Invoice_DueDate] DEFAULT (getutcdate()) NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Invoice1] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [acct].[_Invoice])
    BEGIN
        SET IDENTITY_INSERT [acct].[tmp_ms_xx__Invoice] ON;
        INSERT INTO [acct].[tmp_ms_xx__Invoice] ([ID], [PartyID], [ContractID], [VaultTag], [LedgerSide], [CurrencyID], [DueBalance], [InvoiceAmt], [InvoicedOn], [IssueDate], [DueDate])
        SELECT   [ID],
                 [PartyID],
                 [ContractID],
                 [VaultTag],
        ...
        FROM     [acct].[_Invoice]
        ORDER BY [ID] ASC;
        SET IDENTITY_INSERT [acct].[tmp_ms_xx__Invoice] OFF;
    END

DROP TABLE [acct].[_Invoice];

EXECUTE sp_rename N'[acct].[tmp_ms_xx__Invoice]', N'_Invoice';

EXECUTE sp_rename N'[acct].[tmp_ms_xx_constraint_PK_Invoice1]', N'PK_Invoice', N'OBJECT';
...
GO
/*
The column [tms].[_SvcFactor].[ContractID] on table [tms].[_SvcFactor] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.

The column [tms].[_SvcFactor].[SvcClass] on table [tms].[_SvcFactor] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
GO
PRINT N'Starting rebuilding table [tms].[_SvcFactor]...';
...
CREATE TABLE [tms].[tmp_ms_xx__SvcFactor] (
    [SvcClass]           [dbo].[E8]  NOT NULL,
    [RcvHubID]           [dbo].[I32] NOT NULL,
    [OnZoneCode3]        CHAR (3)    NOT NULL,
    [ContractID]         [dbo].[I32] NOT NULL,
    [HandlingFeeOZ]      REAL        DEFAULT 0 NOT NULL,
    [HandlingFeeLB]      REAL        DEFAULT 0 NOT NULL,
    [FuelSurchargeRatio] REAL        DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_SvcFactor1] PRIMARY KEY CLUSTERED ([SvcClass] ASC, [RcvHubID] ASC, [OnZoneCode3] ASC, [ContractID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [tms].[_SvcFactor])
    BEGIN
        INSERT INTO [tms].[tmp_ms_xx__SvcFactor] ([RcvHubID], [OnZoneCode3], [HandlingFeeOZ], [HandlingFeeLB], [FuelSurchargeRatio], [Factor1], [Factor2], [Factor3], [Factor4], [Factor5], [Factor6], [Factor7], [Factor8], [Factor9])
        SELECT   [RcvHubID],
                 [OnZoneCode3],
                 [HandlingFeeOZ],
                 [HandlingFeeLB],
                 ...
                 [Factor9]
        FROM     [tms].[_SvcFactor]
        ORDER BY [RcvHubID] ASC, [OnZoneCode3] ASC;
    END

DROP TABLE [tms].[_SvcFactor];

EXECUTE sp_rename N'[tms].[tmp_ms_xx__SvcFactor]', N'_SvcFactor';

EXECUTE sp_rename N'[tms].[tmp_ms_xx_constraint_PK_SvcFactor1]', N'PK_SvcFactor', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [tms].[_SvcType]...';
...
CREATE TABLE [tms].[tmp_ms_xx__SvcType] (
    [ID]             [dbo].[I32]  NOT NULL,
    [TenantID]       [dbo].[I32]  NOT NULL,
    [CurrencyID]     [dbo].[E8]   NOT NULL,
    [DutyCurrencyID] [dbo].[E8]   CONSTRAINT [DF_SvcType_DutyCurrencyID] DEFAULT (1) NOT NULL,
    [FallbackPOA]    CHAR (3)     NOT NULL,
    [InitStateID]    [dbo].[I32]  NOT NULL,
    [InitQueue]      VARCHAR (20) CONSTRAINT [DF_SvcType_InitQueue] DEFAULT ('') NOT NULL,
    [ClrMethodID]    [dbo].[I32]  NOT NULL,
    [CmdyRootID]     [dbo].[I32]  CONSTRAINT [DF_SvcType_CmdyRootID] DEFAULT (2) NOT NULL,
    [UseFactor]      BIT          CONSTRAINT [DF_SvcType_UseFactor] DEFAULT (0) NOT NULL,
    [UsePreCheck]    BIT          CONSTRAINT [DF_SvcType_UsePreCheck] DEFAULT (0) NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_SvcType1] PRIMARY KEY CLUSTERED ([ID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [tms].[_SvcType])
    BEGIN
        INSERT INTO [tms].[tmp_ms_xx__SvcType] ([ID], [TenantID], [CurrencyID], [DutyCurrencyID], [FallbackPOA], [InitStateID], [ClrMethodID], [CmdyRootID], [UseFactor])
        SELECT   [ID],
                 [TenantID],
                 [CurrencyID],
                 [DutyCurrencyID],
...
DROP TABLE [tms].[_SvcType];

EXECUTE sp_rename N'[tms].[tmp_ms_xx__SvcType]', N'_SvcType';

EXECUTE sp_rename N'[tms].[tmp_ms_xx_constraint_PK_SvcType1]', N'PK_SvcType', N'OBJECT';
...
GO
ALTER TABLE [tms].[_SvcFactor] WITH NOCHECK
...
GO
ALTER TABLE [tms].[_SvcContract] WITH NOCHECK
...
GO
ALTER TABLE [shpt].[_Parcel] WITH NOCHECK
...
GO
ALTER TABLE [tms].[_SvcRoute] WITH NOCHECK
...
GO
ALTER TABLE [tms].[_SvcRate] WITH NOCHECK
...
GO
PRINT N'Adding schema binding to [tms].[SvcType#Raw]...';
...
GO
PRINT N'Altering [acct].[Charge#ID]...';


GO
--Smile
ALTER FUNCTION [acct].[Charge#ID] ()
RETURNS TABLE
WITH SCHEMABINDING
AS RETURN
(
...
GO
PRINT N'Creating [hub].[Activity$Lookup]...';
...
GO
PRINT N'Creating [hub].[Parcel$ShippingPlanInfo]...';
...
(
	...
	,		t.SourceID, IssueDate, ContractID, InvoiceGroup, PartyID
...
(
	...
	(
		...
		cross	apply tms.SvcCost#ByFactor(x.ContractID, f.ImportZip3, left(x.ZoneCode, 3), substring(x.ZoneCode, 4, 2), x.SvcClass, x.Weight) r
	)
...
GO
PRINT N'Creating [svc].[Parcel$VerifyForOutgated]...';
...
GO
PRINT N'Creating [bo].[Account$IncomeSummary]...';
...
END
GO
PRINT N'Altering [xpd].[Parcel$ReweighForXpd]...';
...
*/
-- Aimee
ALTER PROCEDURE [xpd].[Parcel$ReweighForXpd](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [zeb].[Zack$InitForZeb]...';
...
*/
-- AaronLiu
ALTER PROCEDURE [zeb].[Zack$InitForZeb](@slip tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Creating [bo].[Account$ChargeOffInvoice]...';
...
END
GO
PRINT N'Creating [vmi].[StockInOrder$InitForCainiao]...';
...
END
GO
PRINT N'Altering [shpt].[Parcel#BillForVmi]...';


GO
--Smile
ALTER PROCEDURE [shpt].[Parcel#BillForVmi](@parcelIDs dbo.I64Array readonly)
--WITH ENCRYPTION--
AS
BEGIN
	SET	NOCOUNT    ON;
...
END
GO
PRINT N'Altering [shpt].[Parcel#TalliedOrDeduct]...';


GO
--Smile, PeterHo
ALTER PROCEDURE [shpt].[Parcel#TalliedOrDeduct](@parcelIDs dbo.I64Array readonly)
--WITH ENCRYPTION--
AS
BEGIN
	SET	NOCOUNT    ON;
...
END
GO
PRINT N'Altering [vmi].[StorageFee$Bill]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[StorageFee$Bill](@slip tvp,  @context tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [app].[Parcel$InitForAmz]...';
...
*/
--PeterHo: Todo Smile
ALTER PROCEDURE [app].[Parcel$InitForAmz](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [app].[Parcel$InitForAmzNonSku]...';
...
*/
--Daxia
ALTER PROCEDURE [app].[Parcel$InitForAmzNonSku](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [vmi].[Parcel$Init]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[Parcel$Init](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [api].[Subscriber$DequeueForTC]...';


GO
-- AaronLiu
ALTER PROCEDURE [api].[Subscriber$DequeueForTC](@result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET	NOCOUNT    ON;
...
END
GO
PRINT N'Altering [vmi].[Parcel$Release]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[Parcel$Release](@result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Creating [hub].[Parcel$EndOfDayForUSD]...';


GO
-- Daxia
CREATE PROCEDURE [hub].[Parcel$EndOfDayForUSD](@tenancy tvp)
WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
	...
	BEGIN TRY
		...
		,		@actionID I32=11952;--(select EndOfDay from core.Action#ID());
		...
		where	x.StateID in (38661) -- add MeasureWt and Overlabel State.
		...
		--select	@stateID=x.ToStateID from @spec x;
...
END
GO
PRINT N'Creating [svc].[HubManifest$ImportToSurrender]...';


GO
/*
@slip    = idsInCsv;
@context = Quad<RcvHubID, POA, MawbNbr, Trio<UtcTime, UtcOffSet, UtcPlaceID>>;
@result  = ParcelCnt
*/
--Smile
...
BEGIN
	...
	BEGIN TRY
		...
		declare	@stage     E32=(select Stage    from core.Stage#Of(@stateID));
		declare	@sackMftID I64=next value for core.MatterSeq;
		declare	@hubID     I32=(select v1 from tvp.Quad#Of(@context, default));
	    declare	@utcStamp  tvp=(select v4 from tvp.Quad#Of(@context, default));
		...
		select	@sackMftID, @stateID, cast(t.v1 as datetime2(2)), cast(t.v2 as smallint), cast(t.v3 as int)
		from	tvp.Trio#Of(@utcStamp) t;
...
END
GO
PRINT N'Creating [vmi].[Parcel$ChangeSvcTypeForCainiao]...';


GO
/*
@slip    = Quad[TrackingNbr, SvcType,  PostCourierNbr, LabelInfo]
...
BEGIN
	...
	BEGIN TRY
		...
		with cteParcel as
		(
			select	p.ID, p.SvcType, p.RouteID
			,		NewSvcType=t.ID, NewRouteID=o.RouteID
		...
		update	cteParcel set SvcType=NewSvcType, RouteID=NewRouteID
		output	inserted.ID into @ids;
		...
		(
			select	[text()]=concat(k.Many, m.MatterID, k.Triad, t.ShippingLabelInfo, k.Triad, x.v4)
			from	tvp.Tuplet#Slice(@slip, default, default) x
			cross	apply core.RefNbr#ScanOne(x.v1, default, default) m
			cross	apply tvp.Spr#Const()                                     k
			cross	apply core.RefInfo#Type()                                 t
...
END
GO
PRINT N'Altering [svc].[Route$Confirm]...';
...
*/
--Smile
ALTER PROCEDURE [svc].[Route$Confirm](@slip tvp, @tenancy tvp)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [app].[Parcel$InitForEship]...';
...
*/
--Smile, AaronLiu
ALTER PROCEDURE [app].[Parcel$InitForEship](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [app].[Parcel$InitWithSku]...';
...
*/
--Smile, AaronLiu
ALTER PROCEDURE [app].[Parcel$InitWithSku](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
END
GO
PRINT N'Altering [xpd].[Parcel$MeasureForXpd]...';
...
*/
-- Daxia
ALTER PROCEDURE [xpd].[Parcel$MeasureForXpd](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
	...
	BEGIN TRY
		...
		update	o set o.Weight=n.Text
		from	shpt._Parcel o join @idTexts n on o.ID=n.ID;
...
END
GO
PRINT N'Altering [vmi].[Parcel$Void]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[Parcel$Void](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET	NOCOUNT    ON;
...
END
GO
PRINT N'Altering [shpt].[Parcel#Measure]...';


GO
-- AaronLiu
ALTER PROCEDURE [shpt].[Parcel#Measure](@matterID I64, @tenancy tvp)
--WITH ENCRYPTION
AS
BEGIN
	SET NOCOUNT    ON;
...
@result	= Pair<SackMftMic, Many[Duad<ParcelID, ParcelMic>]>
*/
-- Daxia
...
END
GO
PRINT N'Creating [hub].[Parcel$MeasureForUSD]...';
...
BEGIN
	...
	BEGIN TRY
		...
		;
		--	2	Init FedEx
		declare	@measureWt real=(select	q.v1 from tvp.Quad#Of(@context, N',') q);
		...
		begin
			...
			select	@matterID, x.Type, x.Number,    iif(x.Type=@postCourierPre, @svcClassLW, @svcClassPS)
			from	core._RefNbr x cross apply core.RefNbr#Type() t
			where	x.MatterID=@matterID and x.Type in(@postCourierPre, @postCourierOrg)--t.PostCourier
			;
			...
			begin
				...
				declare	@picSpec tms.PicSpec; insert @picSpec
				(		MeasuredWt,   SvcType, Zip3,                Plus2)
				select	@measureWt, p.SvcType, left(p.ZoneCode, 3), substring(p.ZoneCode, 4, 2)
				from	shpt.Parcel#Base() p where p.ID=@matterID
				;
				--	2.2	Emit PICs:
				declare	@picResult tms.PicResult; insert @picResult
				exec	tms.Pic#Emit @source=@source, @picSpec=@picSpec
				...
				select	@matterID, @newSvcClass, t.TrackingNbr, iif(@newSvcClass=@svcClassLW, @postCourierPre, @postCourierOrg)
...
GO
ALTER TABLE [acct].[_Ledger] WITH CHECK CHECK CONSTRAINT [FK_Ledger_Invoice];

ALTER TABLE [acct].[_VaultXact] WITH CHECK CHECK CONSTRAINT [FK_VaultXact_Invoice];

ALTER TABLE [acct].[_Invoice] WITH CHECK CHECK CONSTRAINT [FK_Invoice_Currency];

ALTER TABLE [acct].[_Invoice] WITH CHECK CHECK CONSTRAINT [FK_Invoice_Party];

ALTER TABLE [acct].[_Invoice] WITH CHECK CHECK CONSTRAINT [FK_Invoice_Contract];

ALTER TABLE [tms].[_SvcFactor] WITH CHECK CHECK CONSTRAINT [FK_SvcFactor_RcvHub];

ALTER TABLE [tms].[_SvcFactor] WITH CHECK CHECK CONSTRAINT [FK_SvcFactor_Contract];

ALTER TABLE [tms].[_SvcFactor] WITH CHECK CHECK CONSTRAINT [FK_SvcFactor_SvcClass];

ALTER TABLE [tms].[_SvcContract] WITH CHECK CHECK CONSTRAINT [FK_SvcContract_SvcType];

ALTER TABLE [shpt].[_Parcel] WITH CHECK CHECK CONSTRAINT [FK_Parcel_SvcType];

ALTER TABLE [tms].[_SvcType] WITH CHECK CHECK CONSTRAINT [FK_SvcType_Tenant];

ALTER TABLE [tms].[_SvcType] WITH CHECK CHECK CONSTRAINT [FK_SvcType_Currency];

ALTER TABLE [tms].[_SvcType] WITH CHECK CHECK CONSTRAINT [FK_SvcType_ClrMethod];

ALTER TABLE [tms].[_SvcType] WITH CHECK CHECK CONSTRAINT [FK_SvcType_InitState];

ALTER TABLE [tms].[_SvcType] WITH CHECK CHECK CONSTRAINT [FK_SvcType_Commodity];

ALTER TABLE [tms].[_SvcRoute] WITH CHECK CHECK CONSTRAINT [FK_SvcRoute_SvcType];

ALTER TABLE [tms].[_SvcRate] WITH CHECK CHECK CONSTRAINT [FK_SvcRate_SvcType];
