...
GO
PRINT N'Altering [shpt].[Parcel#Deep]...';
...
GO
PRINT N'Altering [svc].[Parcel$ForCreateSackMft]...';
...
GO
PRINT N'Altering [svc].[Parcel$ForLoadBalance]...';
...
GO
PRINT N'Altering [svc].[SackMft$Export]...';
...
GO
PRINT N'Altering [shpt].[SackMft#Deep]...';
...
GO
PRINT N'Altering [svc].[Account$Ledger]...';
...
GO
PRINT N'Altering [svc].[Account$StockInOrderLedger]...';
...
GO
PRINT N'Altering [svc].[Batch$ExportForAmazon]...';
...
GO
PRINT N'Altering [svc].[Parcel$CriteriaForLoadBalance]...';
...
GO
PRINT N'Altering [svc].[Parcel$OutgatedList]...';
...
GO
PRINT N'Altering [tms].[Freight#For]...';
...
GO
PRINT N'Creating [shpt].[SackMft#LedgerByCharge]...';


GO
--Daxia
CREATE FUNCTION [shpt].[SackMft#LedgerByCharge](@sackMftID dbo.I64)
RETURNS TABLE
WITH SCHEMABINDING, ENCRYPTION
AS RETURN
(
	...
	(
		...
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbAMSFiling) r
		cross	apply dbo.Money#Make(iif(r.Rate>r.Minimum, r.Rate, r.Minimum), r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbBaseFee) r
		cross	apply dbo.Money#Make(iif(r.Rate>r.Minimum, r.Rate, r.Minimum), r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbAirlineISCFee) r
		cross	apply dbo.Money#Make(iif(r.Rate>r.Minimum, r.Rate, r.Minimum), r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbCfsTransferFuel) r
		cross	apply dbo.Money#Make(iif(r.Rate>r.Minimum, r.Rate, r.Minimum), r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbCfsTransferFee) r
		cross	apply dbo.Money#Make(iif(r.Rate>r.Minimum, r.Rate, r.Minimum), r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbSectionEntryFee) r
		...
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbTerminalTransfer) r
		cross	apply shpt.SackMft#MawbWtRateCalc(r.Rate, x.MawbWt, 1, r.Minimum) mc
		cross	apply dbo.Money#Make(mc.MawbWtAmt, r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbPickUpCharge) r
		cross	apply shpt.SackMft#MawbWtRateCalc(r.Rate, x.MawbWt, 1, r.Minimum) mc
		cross	apply dbo.Money#Make(mc.MawbWtAmt, r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.MawbPalletizing) r
		cross	apply shpt.SackMft#MawbWtRateCalc(r.Rate, x.MawbWt, 150, r.Minimum) mc
		cross	apply dbo.Money#Make(mc.MawbWtAmt, r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.HawbBrkgFee) r
		...
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.HawbBrkgLessthanFee) r
		cross	apply shpt.SackMft#HawbCntRateCalc(x.ID, r.Rate, r.Minimum, 1000) hc
		cross	apply dbo.Money#Make(hc.HawbAmt, r.CurrencyID) c
		UNION	ALL
		select	ChargeAmt=c.Amt,  ChargeID=r.ChargeID, r.CurrencyID
		from	tms.SvcCharge#For(x.HubID, x.BrokerID, x.POA, g.HawbHandlingFee) r
...
GO
PRINT N'Altering [bo].[Account$IncomeSummary]...';
...
GO
PRINT N'Altering [brkg].[BrokerageFee#For]...';
...
GO
PRINT N'Altering [brkg].[DutyRate#For]...';
...
GO
PRINT N'Altering [ic].[Parcel$ForExportActivityInfo]...';
...
GO
PRINT N'Altering [lc].[Parcel$Sorting]...';
...
GO
PRINT N'Altering [vmi].[Parcel$Detail]...';
...
GO
PRINT N'Altering [svc].[Parcel$TrackManyForZPS]...';
...
GO
PRINT N'Altering [vmi].[Parcel$TrackMany]...';
...
GO
PRINT N'Altering [core].[Activity#TrackMany]...';
...
GO
PRINT N'Altering [svc].[Parcel$TrackMany]...';
...
GO
PRINT N'Altering [ic].[SackMft$ForOutgated]...';
...
GO
PRINT N'Altering [svc].[ClientRefNbr$Vefity]...';
...
GO
PRINT N'Altering [vmi].[ClientRefNbr$Vefity]...';
...
GO
PRINT N'Altering [svc].[SackMft$ExportForOutgate]...';
...
GO
PRINT N'Altering [svc].[Parcel$WithChallenge]...';
...
GO
PRINT N'Altering [hub].[Challenge$List]...';
...
GO
PRINT N'Altering [svc].[Parcel$List]...';
...
GO
PRINT N'Altering [svc].[Parcel$ListVia]...';
...
GO
PRINT N'Altering [ic].[Parcel$WithConcern]...';
...
GO
PRINT N'Altering [svc].[Parcel$ExceptionList]...';
...
GO
PRINT N'Altering [svc].[Parcel$ForStage]...';
...
GO
PRINT N'Altering [svc].[SackMft$List]...';
...
GO
PRINT N'Altering [svc].[Parcel$ListForCainiao]...';
...
GO
PRINT N'Altering [xpd].[Parcel$Verify]...';
...
GO
PRINT N'Altering [xpd].[Sack$Verify]...';
...
*/
GO
PRINT N'Altering [core].[RefInfo#ToShippingPlan]...';
...
GO
PRINT N'Altering [core].[RefNbr#MatchMulti]...';
...
GO
PRINT N'Altering [svc].[MIC$Vefity]...';
...
GO
PRINT N'Altering [vmi].[Parcel$ForExport]...';
...
GO
PRINT N'Altering [vmi].[Parcel$List]...';
...
GO
PRINT N'Altering [core].[RefNbr#ScanMulti]...';
...
GO
PRINT N'Altering [svc].[Parcel$Detail]...';
...
GO
PRINT N'Altering [svc].[Parcel$ShippingPlanList]...';
...
GO
PRINT N'Altering [shpt].[Parcel#FreightAndDutyFor]...';
...
GO
PRINT N'Altering [shpt].[Parcel#LedgerByFactor]...';
...
GO
PRINT N'Altering [shpt].[Parcel#LedgerForVmi]...';
...
GO
PRINT N'Altering [tms].[Route#Check]...';
...
GO
PRINT N'Altering [bo].[Account$ExportForDutyInvoice]...';
...
GO
PRINT N'Altering [bo].[Account$ExportForFreightInvoice]...';
...
GO
PRINT N'Altering [svc].[Parcel$TrackForXpd]...';
...
GO
PRINT N'Altering [svc].[Parcel$DetailVia]...';
...
GO
PRINT N'Altering [svc].[Parcel$LabelVia]...';
...
GO
PRINT N'Altering [svc].[Parcel$Label]...';
...
GO
PRINT N'Altering [tvp].[Pcs#TallyT]...';
...
END
GO
PRINT N'Creating [shpt].[SackMft#BillForCharge]...';
