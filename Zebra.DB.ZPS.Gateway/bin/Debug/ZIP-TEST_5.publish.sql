...
GO
PRINT N'Creating [tms].[_SvcCharge]...';


GO
CREATE TABLE [tms].[_SvcCharge] (
    [TenantID]   [dbo].[I32] NOT NULL,
    [BrokerID]   [dbo].[I32] NOT NULL,
    [POA]        CHAR (3)    NOT NULL,
    [ChargeID]   [dbo].[I32] NOT NULL,
    [VendorID]   [dbo].[I32] NOT NULL,
    [Minimum]    REAL        NOT NULL,
    [Rate]       REAL        NOT NULL,
    [CurrencyID] [dbo].[E8]  NOT NULL,
    CONSTRAINT [PK_SvcCharge] PRIMARY KEY CLUSTERED ([TenantID] ASC, [BrokerID] ASC, [POA] ASC, [ChargeID] ASC, [VendorID] ASC)
);


GO
PRINT N'Creating [tms].[FK_SvcCharge_Broker]...';


GO
ALTER TABLE [tms].[_SvcCharge] WITH NOCHECK
    ADD CONSTRAINT [FK_SvcCharge_Broker] FOREIGN KEY ([BrokerID]) REFERENCES [brkg].[_Broker] ([ID]);


GO
PRINT N'Creating [tms].[FK_SvcCharge_Charge]...';


GO
ALTER TABLE [tms].[_SvcCharge] WITH NOCHECK
    ADD CONSTRAINT [FK_SvcCharge_Charge] FOREIGN KEY ([ChargeID]) REFERENCES [acct].[_Charge] ([ID]);


GO
PRINT N'Creating [tms].[FK_SvcCharge_Currency]...';


GO
ALTER TABLE [tms].[_SvcCharge] WITH NOCHECK
    ADD CONSTRAINT [FK_SvcCharge_Currency] FOREIGN KEY ([CurrencyID]) REFERENCES [acct].[_Currency] ([ID]);


GO
PRINT N'Creating [tms].[FK_SvcCharge_Tenant]...';


GO
ALTER TABLE [tms].[_SvcCharge] WITH NOCHECK
    ADD CONSTRAINT [FK_SvcCharge_Tenant] FOREIGN KEY ([TenantID]) REFERENCES [core].[_Tenant] ([ID]);


GO
PRINT N'Creating [tms].[FK_SvcCharge_Vendor]...';


GO
ALTER TABLE [tms].[_SvcCharge] WITH NOCHECK
    ADD CONSTRAINT [FK_SvcCharge_Vendor] FOREIGN KEY ([VendorID]) REFERENCES [core].[_Party] ([ID]);
...
(
	...
	,		44 as MawbAMSFiling
	,		45 as MawbBaseFee
	,		46 as MawbAirlineISCFee
	,		47 as MawbCfsTransferFuel
	,		48 as MawbCfsTransferFee
	,		49 as MawbSectionEntryFee
	,		50 as MawbTerminalTransfer
	,		51 as MawbPickUpCharge
	,		52 as MawbPalletizing
	,		53 as HawbBrkgFee
	,		54 as HawbBrkgLessthanFee
	,		55 as HawbHandlingFee
)
GO
...
GO
PRINT N'Creating [shpt].[SackMft#MawbWtRateCalc]...';
...
GO
PRINT N'Creating [tms].[SvcCharge#Raw]...';


GO
--Daxia
CREATE FUNCTION [tms].[SvcCharge#Raw]()
RETURNS TABLE
WITH SCHEMABINDING, ENCRYPTION
AS RETURN
(
...
GO
PRINT N'Creating [shpt].[SackMft#HawbCntRateCalc]...';
...
GO
PRINT N'Creating [tms].[SvcCharge#For]...';


GO
-- Daxia
CREATE FUNCTION [tms].[SvcCharge#For]
(
	@siteID     int, 
	@brokerID   int, 
	@poa        char(3),
...
GO
ALTER TABLE [tms].[_SvcCharge] WITH CHECK CHECK CONSTRAINT [FK_SvcCharge_Broker];

ALTER TABLE [tms].[_SvcCharge] WITH CHECK CHECK CONSTRAINT [FK_SvcCharge_Charge];

ALTER TABLE [tms].[_SvcCharge] WITH CHECK CHECK CONSTRAINT [FK_SvcCharge_Currency];

ALTER TABLE [tms].[_SvcCharge] WITH CHECK CHECK CONSTRAINT [FK_SvcCharge_Tenant];

ALTER TABLE [tms].[_SvcCharge] WITH CHECK CHECK CONSTRAINT [FK_SvcCharge_Vendor];
