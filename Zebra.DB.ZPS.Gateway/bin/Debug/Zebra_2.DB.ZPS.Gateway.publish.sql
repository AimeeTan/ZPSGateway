...
GO
PRINT N'Rename refactoring operation with key 4ec8c4e4-a3a8-47b0-8f00-92ecdac9d29b is skipped, element [core].[_Action].[LoopInStateID] (SqlSimpleColumn) will not be renamed to LoopEntryID';


GO
PRINT N'Rename refactoring operation with key 0522eb71-1862-4a2c-b552-35c85b87f0bb is skipped, element [core].[_ConcernType].[Stage] (SqlSimpleColumn) will not be renamed to BoundStage';


GO
PRINT N'Rename refactoring operation with key 943156de-ee18-4f20-9deb-e0a740662407, 22175198-375c-4cba-8bb0-ecdaa341df32 is skipped, element [tms].[_SvcZip3] (SqlTable) will not be renamed to [_SvcZoneCode]';


GO
PRINT N'Rename refactoring operation with key cde7cfe2-7e77-4312-95ed-c251bac5a494 is skipped, element [tms].[_SvcZoneCode3].[Zip3] (SqlSimpleColumn) will not be renamed to [ZoneCode3]';


GO
PRINT N'Rename refactoring operation with key 53ecf2d5-2a0c-47a9-884f-51ae6a8e57d5 is skipped, element [tms].[_SvcZone].[OnZip3] (SqlSimpleColumn) will not be renamed to [OnZoneCode3]';


GO
PRINT N'Rename refactoring operation with key e890d6ef-645e-40e0-9869-50bc117e4ab2 is skipped, element [tms].[_SvcZone].[ToZip3] (SqlSimpleColumn) will not be renamed to [ToZoneCode3]';


GO
PRINT N'Rename refactoring operation with key 970a8431-f5b6-4312-bd22-e5d827e9eff9 is skipped, element [tms].[_SvcZone].[SvcType] (SqlSimpleColumn) will not be renamed to [CourierID]';


GO
PRINT N'Rename refactoring operation with key 6de7158f-0689-4f60-b65d-423bfc7addd5 is skipped, element [tms].[_SvcFactor].[SiteID] (SqlSimpleColumn) will not be renamed to [RcvHubID]';


GO
PRINT N'Rename refactoring operation with key cb481f69-69d0-4728-8569-2de74a4900bf is skipped, element [tms].[_SvcFacZoneCode3] (SqlTable) will not be renamed to [_SvcFacZoneCode]';


GO
PRINT N'Rename refactoring operation with key a6680f8f-299f-47d2-90d0-b6f9833ae439 is skipped, element [tms].[_SvcFacZoneCode].[ZoneCode3] (SqlSimpleColumn) will not be renamed to [ZoneCode]';


GO
PRINT N'Rename refactoring operation with key 6341870e-4cf5-4f5c-9c19-413818cd2e6c is skipped, element [whse].[_Asn] (SqlTable) will not be renamed to _StockInOrder';
