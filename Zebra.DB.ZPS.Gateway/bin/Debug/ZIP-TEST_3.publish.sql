...
END
GO
PRINT N'Altering [vmi].[StockInOrder$Create]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[StockInOrder$Create](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET	NOCOUNT    ON;
...
END
GO
PRINT N'Altering [vmi].[StockInOrder$Init]...';
...
*/
--Smile
ALTER PROCEDURE [vmi].[StockInOrder$Init](@slip tvp, @context tvp, @tenancy tvp, @result tvp out)
--WITH ENCRYPTION
AS
BEGIN
	SET	NOCOUNT    ON;
